...
import 'details_station_model.dart';
export 'details_station_model.dart';

class DetailsStationWidget extends StatefulWidget {
  const DetailsStationWidget({
    Key? key,
    this.image,
  }) : super(key: key);
  ...
  @override
  _DetailsStationWidgetState createState() => _DetailsStationWidgetState();
}

class _DetailsStationWidgetState extends State<DetailsStationWidget>
    with TickerProviderStateMixin {
  late DetailsStationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsStationModel());
  }
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 10.0, 0.0, 0.0),
                                              child: Text(
                                                'Donec sodales justo id mauris rhoncus fringilla. Morbi id enim at sem tidunt laoreet',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText1
                                                        .override(
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 10.0, 0.0, 0.0),
                                                child: Text(
                                                  'Donec sodales justo id mauris rhoncus!!!',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyText1
                                                      .override(
                                                    ...
                                                    ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              10.0),
                                                      child: Image.asset(
                                                        'assets/images/img-comment-1.png',
                                                        width: 60.0,
                                                        height: 60.0,
                                                        fit: BoxFit.cover,
                                                      ),
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(10.0),
                                                        child: Image.asset(
                                                          'assets/images/img-comment-2.png',
                                                          width: 60.0,
                                                          height: 60.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(10.0),
                                                        child: Image.asset(
                                                          'assets/images/img-comment-3.png',
                                                          width: 60.0,
                                                          height: 60.0,
                                                          fit: BoxFit.cover,
                                                        ),
